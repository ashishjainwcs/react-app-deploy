...
import { getSiteData } from "../../redux.selectors/product.selector";

const MiniCart = () => {

    const [pendingOrder, setPendingOrder] = useState({});
    const orders = useSelector(getSiteData).siteData.orders;
    const loggedInUserId = useSelector(getSiteData).siteData.loggedInUserId;
